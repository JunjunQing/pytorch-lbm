...
For a geometric wetting correction that shifts the interface position by $\delta$ near the wall, the energy cost is $\Delta f \approx \kappa |\nabla\phi|^2 \delta^2 / \xi$. The resistance force (energy gradient) is $R_{AC} = \partial f/\partial \delta \approx \kappa |\nabla\phi|^2 \delta / \xi$. Using $\kappa = \beta\xi^2/8$ and $|\nabla\phi| \approx 1/(2\xi)$ at the interface: $R_{AC} \approx \beta\xi\delta/32$. The target gradient from the geometric wetting condition scales as $|g_n^{target}| \sim 2/\xi$. For strongly hydrophobic surfaces ($\theta_{eq} \gg 90^\circ$), the required correction $\delta$ is large, making $R_{AC}$ significant relative to $g_n^{target}$.
