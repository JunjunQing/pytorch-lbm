...
Setup: pip install torch --index-url https://download.pytorch.org/whl/xpu
...
DEVICE = 'xpu'
assert torch.xpu.is_available(), "XPU not available — install PyTorch with XPU: pip install torch --index-url https://download.pytorch.org/whl/xpu"
...
def run_case(substrate_type='ridge', R_star=None, We=7.9,
    ...
    return {
        ...
        'machine': 'qingqing_xpu', 'k_history': k_history,
    }
...
def main():
    ...
    # =================================================================
    print("\n" + "=" * 70)
    print("  STUDY 4a: Contact angle sweep on flat (XPU)")
    print("=" * 70)
    ...
    # =================================================================
    print("\n" + "=" * 70)
    print("  STUDY 4a: Contact angle sweep on ridge R*=1.0 (XPU)")
    print("=" * 70)
    ...
    # =================================================================
    print("\n" + "=" * 70)
    print("  STUDY 4b: Contact angle sweep on convex R*=1.0 (XPU)")
    print("=" * 70)
    ...
    # =================================================================
    print("\n" + "=" * 70)
    print("  STUDY 4b: Contact angle sweep on concave R*=1.0 (XPU)")
    print("=" * 70)
    ...
    # =================================================================
    print("\n" + "=" * 70)
    print("  STUDY 4b: Supplementary ridge θ=60 (XPU)")
    print("=" * 70)
    ...
    # =================================================================
    print("\n" + "=" * 70)
    print("  QINGQING XPU RESULTS SUMMARY")
    print("=" * 70)
